...
import styles from "./add-projector.module.css";
const AddProduct = () => {
  ...
  const [categoryId, setCategoryId] = useState("64679236154074f9f2f11eb5");
      ...
      axios
        ...
        .then((response) => {
          ...
          if (message == "Created") {
            ...
            console.log(message);
            window.location.replace("http://localhost:3000/projector-page");
          } else {
            console.log(message);
    ...
    <div className={styles.addProduct}>
      ...
      <div className={styles.signUpHead}>
        <div className={styles.signupButton1}>
          <div className={styles.productName}>ADD PROJECTOR</div>
        </div>
      </div>
    </div>
  );

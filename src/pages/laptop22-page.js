...
const LaptopPageNew = () => {
    ...
    const getLaptopsFromApi = () => {
        fetch("http://localhost:3001/product/laptops12")
            .then((res) => res.json())
            .then((json) => {
        ...
        try {
            fetch(`http://localhost:3001/product/delete/${productId}`, {
                ...
                .then((data) => {
                    ...
                    const { message } = data;
                    if (message == "deleted") {
                        window.location.replace("http://localhost:3000/laptop22-page");
                    }
                })
                .catch((error) => {
            ...
            <div className="pagi" style={{ marginTop: "1728px" }}>
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item ">
                            <a class="page-link" href="/laptop-page" tabindex="-1">Previous</a>
                        </li>
                        <li class="page-item"><a class="page-link" href="/laptop-page">1</a></li>

...
const UpdateProduct = () => {
    ...
    const handleUpdate = async (e) => {
        ...
        await axios
            .put(`http://localhost:3001/product/update/${productId}`, formData, {
                headers: {
            ...
            .then((response) => {
                ...
                if (message == "updated") {
                    ...
                    window.location.replace(
                        "http://localhost:3000/rent-it-website-t-r-y"
                    );
                } else {
                    console.log(message);
                }
            ...
            .catch((error) => {
                ...
                setError("Failed to update product."); // Set the error message
    ...
    const getProduct = () => {
        fetch(`http://localhost:3001/product/get/${productId}`)
            .then((res) => res.json())
            .then((json) => {
        ...
        /> */}
            ...
            <div className={styles.signUpHead}>
                <div className={styles.signupButton1}>
                    <div className={styles.productName}>UPDATE</div>
                </div>
            </div>
        </div>
    );

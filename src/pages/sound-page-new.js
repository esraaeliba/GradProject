...
const LaptopPageNew = () => {
  ...
  const geSoundSysytemsFromApi = () => {
    fetch("http://localhost:3001/product/sound6")
      .then((res) => res.json())
      .then((json) => {
    ...
    try {
      fetch(`http://localhost:3001/product/delete/${productId}`, {
        ...
        .then((data) => {
          ...
          const { message } = data;
          if (message == "deleted") {
            window.location.replace("http://localhost:3000/sound-page-new");
          }
        })
        .catch((error) => {
      ...
      <div className="pagi" style={{ marginTop: "1728px" }}>
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            <li class="page-item"><a class="page-link" href="/sound22-page">2</a></li>
            <li class="page-item"><a class="page-link" href="#">3</a></li>
            <li class="page-item">
              <a class="page-link" href="/sound22-page">Next</a>
            </li>
          </ul>
        </nav>

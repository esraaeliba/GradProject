...
const LaptopPageNew = () => {
    ...
    const geSoundSysytemsFromApi = () => {
        fetch("http://localhost:3001/product/sound12")
            .then((res) => res.json())
            .then((json) => {
        ...
        try {
            fetch(`http://localhost:3001/product/delete/${productId}`, {
                ...
                .then((data) => {
                    ...
                    const { message } = data;
                    if (message == "deleted") {
                        window.location.replace("http://localhost:3000/sound22-page");
                    }
                })
                .catch((error) => {
    ...
    return (
        <div className={styles.laptopPageNew}>
            ...
            <button className={styles.homeToLaptopVector}>
                ...
                <div className={styles.laptops}>Sound System</div>
            </button>
            ...
            <div className="pagi" style={{ marginTop: "1728px" }}>
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item ">
                            <a class="page-link" href="/sound-page-new" tabindex="-1">Previous</a>
                        </li>
                        <li class="page-item"><a class="page-link" href="/sound-page-new">1</a></li>
